...
async (page) => {
  ...
  for (const kw of kws) {
    ...
    try {
      ...
      await page.waitForFunction(() => document.body.innerText.includes('Keyword intelligence'), { timeout: 20000 }).catch(() => {});
      ...
      const pop = parseInt(ins.popularity, 10);
      const comp = parseInt(ins.competitiveness, 10);

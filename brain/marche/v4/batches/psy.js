...
async (page) => {
  const kws = ["cbt","dbt","emdr","panic attack","ocd","phobia","social anxiety","ptsd","trauma","grief","bereavement","inner child","people pleasing","boundaries","gaslighting","codependency","attachment","anxious","avoidant","love languages","couples","marriage","sex tracker","libido","dating safety","situationship","long distance","polyamory","open relationship","coming out","trans","pronouns","asperger","sensory","misophonia","hsp","rumination","overthinking","decision fatigue","executive function","procrastination","body dysmorphia","eating disorder","binge eating","anorexia","body neutral","loneliness","friend making","small talk","public speaking","stuttering","anger log","jealousy","imposter","perfectionism","bpd","aa companion","na","quit smoking","quit vaping","quit porn","quit gambling","quit sugar","dopamine detox","fomo"];
  const results = [];
  for (const kw of kws) {

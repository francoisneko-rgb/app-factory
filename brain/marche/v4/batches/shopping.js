...
async (page) => {
  const kws = ["coupons","cashback","receipt ocr","warranty","loyalty cards","grocery list","pantry","expiry","fridge","thrift","resale","ebay selling","etsy seller","amazon seller","print on demand","mockup"];
  const results = [];
  for (const kw of kws) {

...
async (page) => {
  const kws = ["turtle","hamster","guinea pig","rabbit","ferret","cockatiel","budgie","gecko","tarantula","sheep","cattle","beehive","wildlife rescue","lost pet","pet medication","vet records","pet insurance","flea","tick","axolotl","hermit crab","hedgehog","chinchilla","shrimp","isopod","ant farm","silkworm","pigeon racing","falconry"];
  const results = [];
  for (const kw of kws) {

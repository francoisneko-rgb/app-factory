...
async (page) => {
  const kws = ["lora","rag","claude artifacts","chatgpt wrapper","gemini","character card","ai homework","exam scanner","measure ar","room scan","body scan","squat form","dance score","just dance","yoga pose","sign language translator"];
  const results = [];
  for (const kw of kws) {

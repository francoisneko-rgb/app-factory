...
async (page) => {
  const kws = ["rsvp","potluck","secret santa","gift exchange","wedding planner","seating chart","guestbook","funeral","memorial","neighborhood","hoa","lost found","garage sale","farmers market","food truck"];
  const results = [];
  for (const kw of kws) {

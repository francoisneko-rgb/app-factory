...
async (page) => {
  const kws = ["cholesterol","kidney stones","uti","crohns","colitis","gerd","reflux","migraine tracker","aura","cluster headache","chronic fatigue","asthma","peak flow","copd","allergy","epi pen","seizure","epilepsy","parkinson","tremor","ms","lupus","rheumatoid","psoriasis","eczema","acne","rosacea","hearing test","vision test","ishihara","color blind","glaucoma","dry eye","dental","floss","retainer","braces","medication reminder","aed","blood donation","organ donor","lab results","medical id","wheelchair","ostomy","catheter","dialysis","chemo","cancer journal","pain scale"];
  const results = [];
  for (const kw of kws) {

...
async (page) => {
  const kws = ["fuel log","gas mileage","obd2","car scanner","parking meter","car maintenance","oil change","tire pressure","ev charging","tesla","hybrid","toll","speed camera","radar detector","ebike","scooter","boat nav"];
  const results = [];
  for (const kw of kws) {

...
async (page) => {
  const kws = ["ovulation","fertility","ttc","basal temperature","ivf","kick counter","contraction timer","breastfeeding","pumping","formula","diaper log","white noise baby","colic","reflux baby","sleep training","ferber","solids","weaning","teething","vaccine","potty training","tantrums","gentle parenting","time in","allowance kids","screen time parental","family location","school bus","allergy","epipen","asthma kids","eczema baby","speech delay","stutter kids","autism kids","iep","homework","spelling bee","times tables","handwriting","phonics","bedtime stories","lullaby","night light","car seat","baby proofing"];
  const results = [];
  for (const kw of kws) {

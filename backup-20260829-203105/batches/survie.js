...
async (page) => {
  const kws = ["triathlon","spinning","longboard","wilderness","bushcraft","fire starting","knot","knots","cpr","emergency","disaster","earthquake","tsunami","flood","hurricane","tornado","wildfire","off grid","solar","water filter","foraging","animal tracks","compass","altimeter","barometer","topographic","topo map","trail map","gpx","waypoint","geocache","orienteering","star","stargazing","constellation","aurora","ham radio","scanner radio","walkie talkie","morse code","bug out bag","edc","knife","reload"];
  const results = [];
  for (const kw of kws) {
